...
>>> PyNetTools.parsePortScan(PyNetTools.portScan(PyNetTools.getPrivateIP(), 80), PyNetTools.getPrivateIP())[0]
['192.168.0.1']
>>> PyNetTools.parsePortScan(PyNetTools.portScan(PyNetTools.getPrivateIP(), 80), PyNetTools.getPrivateIP())[1]
